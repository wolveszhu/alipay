...
<div id="main">
    ...
    <form name="alipayment" action="<?php echo U('Pagepay/pagePay');?>" method="post" target="_blank">
    ...
    <form name="tradequery" action=<?php echo U('Pagepay/query');?> method="post" target="_blank">
    ...
    <form name="traderefund" action="<?php echo U('Pagepay/refund');?>" method="post" target="_blank">
    ...
    <form name="traderefundquery" action="<?php echo U('Pagepay/refundQuery');?>" method="post" target="_blank">
    ...
    <form name="tradeclose" action=<?php echo U('Pagepay/close');?> method="post" target="_blank">
